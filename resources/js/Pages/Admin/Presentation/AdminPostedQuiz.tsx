...
export default function AdminPostedQuiz(props: any) {
    const { postedQuiz, handleClickDeleteQuiz } = props;
                            ...
                            <div className="grid grid-cols-3 gap-5 mt-10">
                                {quiz.choices.map((choice: any) => (
                                    <div
                                        className={
                                            choice.isTrue === 1
                                                ? "rounded-[10px] border border-gray-800 p-5 bg-emerald-700 cursor-pointer "
